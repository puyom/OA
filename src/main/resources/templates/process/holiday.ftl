		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					<td  colspan="6"><input type="text" class="form-control inpu holistart"  id="startTime" name="proId.startTime"/></td>
					<td class="title" ><label class="control-label">结束日期</label></td>
					<td  colspan="6"><input type="text" class="form-control inpu holiend"  id="endTime" name="proId.endTime"/></td>
				</tr>
					<tr >
					...
					<#else>
					<td  colspan="6"><input name="nameuser" type="text" id="recive_list"
								class="form-control " readonly="readonly" style="background-color:#fff;" value="${u.userName}"/>
							<#--<div class="reciver">
