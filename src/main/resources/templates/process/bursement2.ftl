...
<div class="row" style="padding-top: 10px;">
	<div class="col-md-2">
		<h1 style="font-size: 24px; margin: 0;" class="">付款申请</h1>
	</div>
	...
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					<td colspan="14" class="title"><h2>付款申请单</h2></td>
				...
				<tr >
					...
					<td class="title" ><label class="control-label">相关人员</label></td>
				...
				<tr >
					...
					<#if shen.getUserId()==2||shen.getUserId()==3>
						 <td  colspan="6"><input type="text" class="form-control inpu" name="username" value="高芳"></td>
					<#else>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="username" value="${u.userName}"></td>
					</#if>
				...
				<tr>
                    <td class="title"><label class="control-label">账号</label></td>
                    <td colspan="6"><input type="text" class="form-control inpu" name="card" value="${shen.bank}"/></td>
					...
					<td  colspan="6">
						<div class="btn btn-default"style="position: relative; overflow: hidden;width: 100%;margin-top: -6px;">
							<i class="glyphicon glyphicon-open"></i> 点击上传票据
							<input type="file" name="filePath"  style="opacity: 0; position: absolute;
								 top: 12px; right: 0; " class="input">
						</div>
					</td>
				</tr>
					<tr>
                        <td class="title" ><label class="control-label">收款单位</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="unit" value="${shen.userName}"/></td>
                        <td class="title" ><label class="control-label">开户银行</label></td>
                        <td  colspan="6"><input type="text" class="form-control inpu" name="bank" value="${shen.userSign}"/></td>

					</tr>
				<tr >


					<td class="title" ><label class="control-label">付款事由</label></td>
					<td  colspan="6"><textarea class="form-control text" name="proId.processDescribe"></textarea></td>

				</tr>
				<tr >
					<td class="title"><label class="control-label">支付明细</label></td>
                            ...
                            <div class="food">
                                <table class="table inside">
                                    ...
                                    <tr class="tr">
                                        ...
                                        <td colspan="2"><input type="text" class="form-control inpu" name="details[0].introduce"/></td>
                                    </tr>
				...
				<tr >
					...
					<td colspan="14" style="text-align: right;" >
						<input   type="text" value="付款申请" name="val" hidden="hidden"/>
