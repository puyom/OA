...
<#--<div class="row" style="padding-top: 10px;">
	...
	&lt;#&ndash;<div class="col-md-10 text-right">
						...
						<div  class="out">
							<table class="table ob ">
								...
								<tr>
									...
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(eve.moneyAdvice)!''}</p></td>
								</tr>
                                <tr>
                                    <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        <div class="mon">
				...
				<tr class="fo">
					...
					<td colspan="14" style="text-align: right;" >
						<div class="pull-right foot">
							...
							<a id="print1" class="btn btn-default fault" onclick="print1()">
							...
							<#else>
								<#--<#if map.statusid==25>
								&lt;#&ndash;<a class="btn btn-primary huifu" href="evemoney?id=${map.proId}">
							       <span class="glyphicon glyphicon-zoom-in"></span> 出差费用申请</a> &ndash;&gt;
								</#if>-->
							</#if>
						</div>
				 </td>
...
<script>
    ...
    function print1(){
       ...
       /* var obj=document.getElementById("print2");
        if(obj==null){
