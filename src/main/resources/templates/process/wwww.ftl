		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					<tr>
                        <td colspan="14"><p style="color: red">温馨提示:一个项目进度的开始时间和结束时间一旦保存无法更改</p></td>
					</tr>
				<tr style="opacity: 0;">
					<td colspan="14">11</td>
				</tr>
				<tr>
					...
					<tr>
                        ...
                        <td  colspan="6"><input type="text" class="form-control inpu" name="team" value="${(stay.team)!''}"/></td>
					</tr>
						...
						<table class="table inside">
							<thead>
								<tr>
									 ...
									 <#--<th colspan="2">项目天数</th>-->
									 <#--<th colspan="2">是否延期</th>-->
									 <th colspan="2">完成</th>
                                     <th colspan="2">未完成</th>
							...
							<tr class="tr">
									...
									<#--<td colspan="2"><input type="text" class="form-control inpu shijian" name="details[0].StartTime" /></td>-->
									<#--<td colspan="2"><input type="text" class="form-control inpu" name="details[0].projectSchedule"/></td>-->
									<#--<td colspan="2"><input type="text" class="form-control inpu" id="starTime" name="details[0].startTime2"/></td>-->
									<#--<td colspan="2"><input type="text" class="form-control inpu" id="endTime" name="details[0].endTime"/></td>-->
									<#--<td colspan="2"><input type="text" class="form-control inpu days" /></td>-->
									<#--<td colspan="2"><input type="text" class="form-control inpu days2" /></td>-->
									<td colspan="2"><input type="text" class="form-control inpu" name="details[0].complete"/></td>
									<td colspan="2"><input type="text" class="form-control inpu" name="details[0].unfinished"/></td>
									<td colspan="2" class="tdrig"><input type="text" class="form-control inpu"	name="details[0].point"/></td>
                                	<td colspan="2"><input type="text" class="form-control inpu" name="details[0].coordination"/></td>
								</tr>
							</tbody>
						</table>
					</div>
                    ...
                    <tr class="rile">
                        <td colspan="14">
                            ...
                            <tr class="tr">
                                ...
                                <td colspan="2"><span>${(pro.user)!''}</span></td>
                            </tr>
							</#list>
								<#--</tbody>-->
                                </table>
                        ...
                        <td colspan="14">
							...
							<#-- <td colspan="2"><span>${(detail.projectSchedule)!''}</span></td>
                             ...
                             <td colspan="2"><span>${(detail.endTime)!''}</span></td>-->
                                ...
                                <td colspan="2"><span>${(detail.user)!''}</span></td>
                            </tr>
							</#list>
								<#--</tbody>-->
                                </table>
