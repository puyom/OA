		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr>
                    ...
                    <td  colspan="6"><input type="text" class="form-control " id="starTime"  name="proId.startTime"/></td>
                    <#--<td colspan="6"><input type="text" class="form-control inpu shijian" name="proId.startTime" /></td>-->
                    ...
                    <td  colspan="6"><input type="text" class="form-control " id="endTime" name="proId.endTime"/></td>
                    <#--<td colspan="6"><input type="text" class="form-control inpu shijian" name="proId.endTime" /></td>-->
				...
				<tr>
					...
					<#if shen.getUserId()==2||shen.getUserId()==3>
						 <td  colspan="6"><input type="text" class="form-control inpu" name="nameuser" value="高芳"></td>
					<#else>
                    <td  colspan="6"><input type="text" class="form-control inpu" name="nameuser" value="${u.userName}"></td>
					</#if>
				</tr>
				<tr>
