<div id="smallDiv"
	...
	<#--<div style="text-align: center; height: 50px; padding-top: 7px;" class="green-g">
		&lt;#&ndash;<a href="#"><img src="images/logo_1.png" /></a>&ndash;&gt;
		<a href="#">蓝普金睛OA自动办公系统</a>
	</div>-->
	<div class="list-left"
...
<div class="col-lg-2 col-md-2 smallDiv"
	...
	<div class="col-md-12 green-g" >  <#---->
		<a href="index" class="navbar-brand" style="padding: 8px;color: white;font-size: 30px">蓝普金睛办公系统</a>
			<#--<a href="index"><img src="/images/lpjj3.png" style=" margin-left:30px;"></a>-->
<#--
